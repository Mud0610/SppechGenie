...
train_button = Button(root, text="Train Model",
                      command=lambda: train_model(extract_mfccs()))
train_button.pack()

recognize_button = Button(root, text="Recognize Voice",
                          command=lambda: recognize_voice(clf))
